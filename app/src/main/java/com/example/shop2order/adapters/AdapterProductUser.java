...
import com.example.shop2order.FilterProductUser;
...
public class AdapterProductUser extends RecyclerView.Adapter<AdapterProductUser.HolderProductUser> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderProductUser holder, int position) {
        ...
        if (noStock.equals("true")){
           ...
           // holder.addToCartTv.setEnabled(false);
            ...
            holder.addToCartTv.setEnabled(true);
        }
        ...
        holder.addToCartTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //add product to cart
                if (noStock.equals("true")){
                    Toast.makeText(context,"Sorry, This product currently unavailable",Toast.LENGTH_LONG).show();
                }
                else {
    ...
    private void showQuantityDialog(ModelProduct modelProduct) {
        ...
        TextView finalPriceTv=view.findViewById(R.id.finaPricelTv);
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String quanty=quantityTv.getText().toString().trim();

                //add to db(SQLite)
                addToCart(productId,title,priceEach,totalPrice,quanty);
                dialog.dismiss();
            }
        });
    }
    ...
    private void addToCart(String productId, String title, String priceEach, String price, String quanty) {
        itemId++;

        EasyDB easyDB = EasyDB.init(context, "ITEM_DB")// TEST is the name of the DATABASE
                .setTableName("ITEM_TABLE")  // You can ignore this line if you want
    ...
    class HolderProductUser extends RecyclerView.ViewHolder{
        ...
        private TextView discountedNoteTv,titleTv,descriptionTv,addToCartTv,discountedPriceTv,originalPriceTv,productNoStockTv,
                productCategoryTv,productQuantityTv;
