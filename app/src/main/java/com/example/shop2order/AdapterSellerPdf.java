...
public class AdapterSellerPdf extends RecyclerView.Adapter<AdapterSellerPdf.HolderPdfAdmin> {
    ...
    public AdapterSellerPdf(Context context, ArrayList<ModelAPdf> pdfArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderPdfAdmin holder, int position) {
        ...
        holder.deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference ref= FirebaseDatabase.getInstance().getReference("Users").child(uid).child("Documents");
                ref.child(id).removeValue()
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void unused) {
                                Toast.makeText(context,"The document is successfully deleted",Toast.LENGTH_LONG).show();
                            }
                        })
