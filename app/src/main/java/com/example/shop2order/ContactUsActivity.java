...
public class ContactUsActivity extends AppCompatActivity {
    ...
    private void inputData() {
        ...
        if(TextUtils.isEmpty(text)){
            Toast.makeText(this,"Enter Contact Us...",Toast.LENGTH_LONG).show();
            return;
        }
        ...
        //save to db
        DatabaseReference ref= FirebaseDatabase.getInstance().getReference("Contact");
        ref.child("contact").child("cu").setValue(text)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(ContactUsActivity.this,"Contact Us added successfully...",Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //failed updating db
                        progressDialog.dismiss();
                        Toast.makeText(ContactUsActivity.this,"Contact Us Conditions not added...",Toast.LENGTH_SHORT).show();
